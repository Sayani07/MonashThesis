...
# Integration of spatial aspect to deconstructed temporal components in visualizing probability distribution {#ch:probtemporal}
...
## Local Indicators of Spatial Association {#sec:expsmooth}
